#!/bin/bash
# Add ssh-keys
mkdir -p /home/bitnami/keys
chmod 700 /home/bitnami/keys

KEY_PATHS="{{KEY_PATHS}}"

for key_path in $KEY_PATHS; do
  cp "$key_path" /home/bitnami/keys/
done

for key_path in /home/bitnami/keys/*.pub; do
  cat "$key_path" >> /home/bitnami/.ssh/authorized_keys
done
